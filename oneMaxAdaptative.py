...
OPERATORS = [bit_flip,one_flip,trois_flips,cinq_flips]#,best_op]#,"negative-flip"]
...
def main():
    Mean_maxFitnessValues,Mean_meanFitnessValues,mean_proba_op = rouletteAdaptative()
    ...
    #plt.plot(mean_proba_op[3], color='black', label='5-flip')
    #plt.plot(mean_proba_op[4], color='orange', label='Operateur parfait')
    plt.legend()
    plt.xlabel('Generation')
